...
func Translate(jsonConfig interface{}, os string) (*otelcol.Config, error) {
	...
	translators.Set(prometheus.NewTranslator(prometheus.WithSection(common.LogsKey)))
	translators.Set(prometheus.NewTranslator(prometheus.WithSection(common.MetricsKey)))
